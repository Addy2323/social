        ...
        <form action="{{ route('admin.students.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="student_id" id="student_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('student_id') }}" required>
                ...
                <div>
                    ...
                    <input type="text" name="admission_number" id="admission_number" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('admission_number') }}" required>
                ...
                <div>
                    ...
                    <input type="date" name="date_of_birth" id="date_of_birth" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('date_of_birth') }}" required>
                ...
                <div>
                    ...
                    <input type="date" name="admission_date" id="admission_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" value="{{ old('admission_date') }}" required>
                ...
                <div class="md:col-span-2">
                    ...
                    <select name="parents[]" id="parents" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm" multiple>
                        @foreach ($parents as $parent)
                            <option value="{{ $parent->id }}" {{ in_array($parent->id, old('parents', [])) ? 'selected' : '' }}>{{ $parent->user->name }} ({{ $parent->user->email }})</option>
                        @endforeach
                    </select>
            ...
            <div class="flex justify-end mt-6">
                ...
                <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Create Student</button>
            </div>
        </form>
    </div>
@endsection
