    ...
    <div class="flex h-screen">
        ...
        <div class="w-64 bg-white shadow-lg">
            ...
            <div class="p-6 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Parent Panel</p>
                    </div>
                </div>
            </div>
            ...
            <nav class="p-4 space-y-2">
                <a href="{{ route('parent.dashboard') }}" class="flex items-center px-4 py-3 text-white bg-gray-900 rounded-lg">
                    <i class="fas fa-home w-5 mr-3"></i>
                    <span class="font-medium">Dashboard</span>
                </a>
                <a href="{{ route('parent.children') }}" class="flex items-center px-4 py-3 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors">
            ...
            <div class="p-6">
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 mt-1">{{ $children->count() }}</p>
                            ...
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 mt-1">
                                    @if($childrenStats->count() > 0)
                                        {{ round($childrenStats->avg('attendance_percentage'), 0) }}%
                                    @else
                                        93%
                                    @endif
                                </p>
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-gray-900 mt-1">B+</p>
                                <p class="text-sm text-gray-500 mt-1">-0.1 from last month</p>
                            </div>
                    ...
                    <div class="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-red-600 mt-1">-$50 from last month</p>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                        ...
                        <div class="p-6">
                            <div class="space-y-3">
                                <a href="{{ route('parent.children') }}" class="flex items-center justify-between p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors">
                                    <span class="text-blue-700 font-medium">View Child's Progress</span>
                                    <i class="fas fa-arrow-right text-blue-500"></i>
                                </a>
                                <a href="#" class="flex items-center justify-between p-4 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors">
                                    <span class="text-gray-700 font-medium">Pay Fees</span>
